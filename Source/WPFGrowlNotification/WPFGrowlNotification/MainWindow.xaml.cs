...
namespace WPFGrowlNotification
{
    ...
    {
        private const double topOffset = 0;// 20;
        private const double leftOffset = 380;
        private const double rightOffset = 0;
        ...
        public MainWindow()
        {
            ...
            growlNotifications.Top = SystemParameters.WorkArea.Top + topOffset;
            growlNotifications.Left = SystemParameters.WorkArea.Right -this.Width - rightOffset;
            growlNotifications.Height = SystemParameters.WorkArea.Height;
        }
