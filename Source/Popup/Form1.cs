...
namespace HFS.Popup
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            taskbarNotifier1.SetCloseBitmap(Resource1.close, Color.FromArgb(255, 0, 255), new Point(300, 8));
            taskbarNotifier1.TitleRectangle = new Rectangle(10, 5, 280, 25);
            taskbarNotifier1.ContentRectangle = new Rectangle(10, 35, 300, 120);
