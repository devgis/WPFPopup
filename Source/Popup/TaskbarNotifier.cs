...
namespace HFS.Popup
{
    public partial class TaskbarNotifier : Form
    {
        ...
        protected Font normalTitleFont = new Font("黑体", 14, FontStyle.Regular, GraphicsUnit.Pixel);
        protected Font hoverTitleFont = new Font("黑体", 14, FontStyle.Regular, GraphicsUnit.Pixel);
        protected Font normalContentFont = new Font("黑体", 12, FontStyle.Regular, GraphicsUnit.Pixel);
        protected Font hoverContentFont = new Font("黑体", 12, FontStyle.Regular, GraphicsUnit.Pixel);
        ...
        public TaskbarNotifier()
        {
            ...
            this.SetBackgroundBitmap(Resource1.skin, Color.FromArgb(255, 0, 255));
            this.SetCloseBitmap(Resource1.close, Color.FromArgb(255, 0, 255), new Point(300, 8));
        }
        #endregion
        ...
        protected void DrawText(Graphics grfx)
        {
            if (titleText != null && titleText.Length != 0)
            {
                ...
                sf.Alignment = StringAlignment.Near; //Near
                sf.LineAlignment = StringAlignment.Center; //StringAlignment.Center;
            ...
            if (contentText != null && contentText.Length != 0)
            {
                ...
                sf.LineAlignment = StringAlignment.Near; //Center
